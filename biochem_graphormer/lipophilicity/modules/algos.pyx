...
def floyd_warshall(adjacency_matrix):
    ...
    cdef numpy.ndarray[long, ndim=2, mode='c'] path = -1 * numpy.ones([n, n], dtype=numpy.compat.long)
...
def gen_edge_input(max_dist, path, edge_feat):
    ...
    cdef numpy.ndarray[long, ndim=4, mode='c'] edge_fea_all = -1 * numpy.ones([n, n, max_dist_copy, edge_feat.shape[-1]], dtype=numpy.compat.long)
